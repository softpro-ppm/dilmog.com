        ...
        <div class="roww borderr" style="margin-top: -2px;">
            ...
            <div class=" borderr-left">
                <table>
                    ...
                    {{-- @dd($show_data) --}}
                    @php $total =  $show_data->deliveryCharge + (float)$show_data->codCharge + (float)$show_data->tax  + (float)$show_data->insurance   @endphp
                    <tr>
                    ...
                    @if($show_data->parcel_source == 'p2p')
                    <tr>
                        <th class="border-right-none">Custom Amount</th>
                        <td class="border-left-none text-right bold color2">
