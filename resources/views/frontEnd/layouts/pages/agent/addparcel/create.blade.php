...
@section('content')
    ...
    <section class="content">
        <style>
         ...
         /* Make the selected option uppercase */
            /* #merchantId + .select2-container .select2-selection__rendered {
                text-transform: uppercase !important;
            } */

            /* Make the dropdown options uppercase */
            /* #merchantId + .select2-container .select2-results__option {
                text-transform: uppercase !important;
            } */
                    ...
                    <div class="box-content">
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-12">
                                ...
                                @endif
                                <!-- form start -->
                                <form role="form" action="{{ route('agent.parcel-store') }}" method="POST"
                                    enctype="multipart/form-data" id="AgentShipmentForm">
                                    @csrf
                                    <div class="row">
                                        <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <select
                                                    class="merchantt form-control select2 {{ $errors->has('merchantId') ? ' is-invalid' : '' }}"
                                                    ...
                                                    @endforeach
                                                    {{-- @foreach ($merchants as $value)
                                                    <option value="{{ $value->id }}" data-pickupLocation="{{ $value->pickLocation }}" data-ins_cal_permission="{{$value->ins_cal_permission}}" data-cod_cal_permission="{{$value->cod_cal_permission}}">{{ $value->lastName }}
                                                        ({{ $value->phoneNumber }})
...
<script src="{{ asset('backEnd/') }}/plugins/select2/js/select2.full.min.js"></script>
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            const form = document.getElementById("AgentShipmentForm"); // Select form
