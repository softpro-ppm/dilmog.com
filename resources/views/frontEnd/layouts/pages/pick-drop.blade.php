...
<div class="container-fluid bg-breadcrumb">
    <div class="container text-center py-5" style="max-width: 900px;">
        <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Pick & Drop Services</h4>
        <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
            <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
            <li class="breadcrumb-item"><a href="#">Services</a></li>
            <li class="breadcrumb-item active text-primary">Pick & Drop</li>
        </ol>    
    </div>
</div>
<!-- Header End -->

<!-- Pick & Drop Service Start -->
<div class="container-fluid service py-5">
    <div class="container py-5">
        <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
            <h4 class="text-primary">Pick & Drop Services</h4>
            <h1 class="display-4 mb-4">Convenient Pick & Drop Solutions</h1>
            <p class="mb-0">Our pick & drop services are designed to provide hassle-free transportation of your parcels. With flexible scheduling and reliable delivery, we ensure your items are picked up and dropped off on time.</p>
        </div>
