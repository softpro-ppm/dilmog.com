...
@section('content')
    ...
    <!-- Header Start -->
    <div class="container-fluid bg-breadcrumb" style="background: linear-gradient(135deg, #db0022 0%, #af251b 100%); padding: 80px 0 40px;">
        <div class="container text-center py-5" style="max-width: 900px;">
            <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">Book Parcel (P2P)</h4>
            <p class="text-light mb-4" style="font-size: 1.2rem;">Fast, reliable, and secure peer-to-peer delivery service</p>
            <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                <li class="breadcrumb-item"><a href="{{ url('/') }}" class="text-light">Home</a></li>
                <li class="breadcrumb-item active text-warning">Book Parcel (P2P)</li>
            </ol>    
        </div>
    </div>
    <!-- Header End -->
