    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function devlieryCharge() {
                ...
                var stateCharge = parseInt($('select[name="deliverycity"] option:selected').attr('data-deliverycharge') || 0);
                var extraCharge = parseInt($('select[name="deliverycity"] option:selected').attr('data-extradeliverycharge') || 0);
                var cod = parseFloat($('select[name="deliverycity"] option:selected').attr('data-codcharge') || 0);
                var zoneCharge = parseInt($('select[name="deliverytown"] option:selected').attr("data-towncharge") || 0);
                var taxPercent = parseFloat($('select[name="deliverycity"] option:selected').attr("data-tax") || 0);
                var insurancePercent = parseFloat($('select[name="deliverycity"] option:selected').attr("data-insurance") || 0);
                
                // Get the cash value depending on payment option
                var cash = payment_option == 1 ? convertCommaSeparatedToNumber($("input[name='package_value']").val()) : convertCommaSeparatedToNumber($("input[name='cod']").val());
