    ...
    <div class="merchant-logo">
        <a href="{{ url('/') }}">
            @if(isset($darklogo) && count($darklogo))
                <img src="{{ asset($darklogo[0]->image) }}" alt="Deliveryman Logo" style=" width:auto; display:block;">
            @else
                <img src="{{ asset('assets/img/logo.png') }}" alt="Deliveryman Logo" style="width:auto; display:block;">
            @endif
        </a>
    </div>
</div>
<div class="center-flex">
    <div class="reset-card">
        <h1><strong>Deliveryman Password Forget</strong></h1>
        ...
        <form action="{{url('auth/deliveryman/password/reset')}}" method="post">
            @csrf
        ...
        <div style="text-align:center; margin-top: 18px; font-size: 1.1rem; color: #222;">
            <span>Back to </span><a href="{{ url('deliveryman/login') }}" style="text-decoration: underline; color: #222; font-weight: 500;">Sign In</a>
        </div>
    </div>
</div>
@endsection