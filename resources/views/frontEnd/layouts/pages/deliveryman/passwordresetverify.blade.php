...
@section('title','Deliveryman Password Reset Verify')
@section('content')
...
.merchant-logo img { margin-top: 5px !important; max-height: 48px !important; }
.merchant-logo img {
...
<div class="login-container">
    <div class="glass-card">
        <h2>Deliveryman Password Reset</h2>
        <form action="{{url('auth/deliveryman/resetpassword/verify')}}" method="post">
                @csrf
            ...
            <div class="register-link">
                Remember your password? <a href="{{ url('deliveryman/login') }}">Back to login</a>
                    </div>
                </form>
            </div>
        </div>
