                                     ...
                                     <table width="100%" cellpadding="0" cellspacing="0"
                                         ...
                                         <tr>
                                             <td><a href="#">
                                                     ...
                                                     <img alt="Image" src="https://zidrop.com/email/images/Logo-For-Zidrop-Logistics.png" style="margin-left: auto; margin-right: auto; display:block; margin-bottom: 10px; height: 40px;" title="Image" width="180" />
                                                 </a></td>
                                         </tr>
                                         <tr
                                             style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                             <td class="content-block"
                                                 ...
                                                 valign="top"> Welcome To ZiDrop Express</td>
                                         </tr>
                                         <tr
                                             style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                             <td class="content-block"
                                                 ...
                                                 valign="top">Password reset token.</td>
                                         </tr>
                                         <tr
                                             style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                             <td class="content-block"
                                                 ...
                                                 valign="top">Dear Deliveryman, Your password reset token is
                                                 {{ $verifyToken }} ,Thanks for using ZiDrop Express</td>
                                         </tr>
                                         <tr
                                             style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                                             <td class="content-block"
                                                 style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; padding-top: 5px; text-align: center; vertical-align: top;text-align: center; margin: 0; text-align: right;"
                                                 valign="top"><b>Developed By</b> - <a
                                                     href="https://www.facebook.com/yearulislamonem"></a></td>
                                         </tr>
                                     </table>
                                 </td>
                             </tr>
