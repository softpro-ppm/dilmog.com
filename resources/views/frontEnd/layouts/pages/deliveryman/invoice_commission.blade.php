        ...
        <div class="invoice-box">
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p> Time: {{ date('h:i:s a', strtotime($DeliverymanCommission->first()->created_at)) }}
                                    </p>

                                    <p> Date : {{ date('F d, Y', strtotime($DeliverymanCommission->first()->created_at)) }}
                                    </p>

                                    <p>Deliveryman Name : {{ $DeliverymanCommission->deliveryman->name }}</p>
                                    <p>Deliveryman Phone : {{ $DeliverymanCommission->deliveryman->phone }}</p>
                                    <p></p>
                                </td>
                            </tr>
                        </table>
                ...
                <tbody>
                    ...
                    @foreach ($parcels as $key => $value)
                        <tr class="item">
                            ...
                            <td>
                                <center>{{ number_format($value->deliveryman_commission, 2) }} N</center>
                            </td>
                        </tr>
                    @endforeach
                    <tr class="heading">
                        ...
                        <td></td>
                        <td></td>
                        <td>Total: {{ number_format($DeliverymanCommission->deliveryman_commission, 2) }} N</td>
                    </tr>
                </tbody>
            </table>

            <br>
            Total Deliveryman Commission Payment Amount:
            {{ number_format($DeliverymanCommission->deliveryman_commission, 2) }} N
            <br>

            <!--Amount in Words----------->
            Total Deliveryman Commission Payment Amount in Words:
            ...
            <table style="width:138%">
                <tr>
                    ...
                    <th></th>
                    <th><u>Deliveryman Signature</u></th>
                </tr>
            </table>
            <br>
            <br>
