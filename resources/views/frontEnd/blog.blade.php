    ...
    <div class="container py-5">
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.2s">
                <div class="blog-item">
                    <div class="blog-img">
                        <img src="/LifeSure-1.0.0/img/blog-1.png" class="img-fluid rounded-top w-100" alt="Blog Image 1">
            ...
            <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.4s">
                <div class="blog-item">
                    <div class="blog-img">
                        <img src="/LifeSure-1.0.0/img/blog-2.png" class="img-fluid rounded-top w-100" alt="Blog Image 2">
                        <div class="blog-categiry py-2 px-4">
            ...
            <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.6s">
                <div class="blog-item">
                    <div class="blog-img">
                        <img src="/LifeSure-1.0.0/img/blog-3.png" class="img-fluid rounded-top w-100" alt="Blog Image 3">
                        <div class="blog-categiry py-2 px-4">
                            <span>Health</span>
                        </div>
                    </div>
