                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        <strong>Hi {{ $sender->sender_name }},</strong></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;">Your parcel (Tracking Code:
                                                                        <strong>{{ $parcel->trackingCode }}</strong> ) has been Created:
                                                                    </p>
                                                                    <br>
                                                                    <p style="margin: 0;"> </p>
                                                                    ...
                                                                    <p style="margin: 0;"><strong>Note:</strong>
                                                                        ...
                                                                        <br>
                                                                    <p style="margin: 0;"> </p>
                                                                    <p style="margin: 0;"><strong>Declared Value:</strong>
                                                                        ₦{{ number_format($parcel->package_value, 2) }}</p>
                                                                        <br>
                                                                    <p style="margin: 0;"> </p>
                                                                    <p style="margin: 0;">
