                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        <strong> Dear {{ $merchant->companyName }} (<a
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;">It's a delight to on-board you on our e-Commerce platform - ZIDROP.
                                                                    </p>
                                                                   
                                                                    <p style="margin: 0;"> </p>
                                                                    <p style="margin: 0;"><strong>Below are your login details:<:
                                                                        </strong>
                                                                        <a href="{{ route('frontend.merchant.login') }}">Visit ZiDrop</a>
                                                                    </p>
                                                                    <p style="margin: 0;"> </p>
                                                                    ...
                                                                    <p style="margin: 0;"><strong>Password:</strong>
                                                                        Use the password that you entered during
        registration.
                                                                    </p>
                                                                    <p style="margin: 0;"> </p>
                                                                    ...
                                                                    <p style="margin: 0;"><strong>Account Name: </strong>Zidrop Logistics</p>
                                                                    <p style="margin: 0;"><strong>Account Number: </strong>5600979340</p>
                                                                    <p style="margin: 0;"><strong>Bank: </strong>Fidelity Bank</p>
                                                                    <br />
                                                                    <p style="margin: 0;">
