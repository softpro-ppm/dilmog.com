...
<head>
    <title>Subscription Mail Deactivate</title>
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;">Your Subscription Plan (<strong>{{ $plan->name }}</strong> ) has been Deactivated:
                                                                    </p>
                                                                    <p style="margin: 0;"> </p>
                                                                    <p style="margin: 0;"><strong>Reason:
                                                                        </strong>Auto Expired</p>
                                                                    <p style="margin: 0;"> </p>
