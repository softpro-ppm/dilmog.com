...
<body style="background-color: #F8F8F8; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
    <table border="0" cellpadding="0" cellspacing="0" class="nl-container" role="presentation"
        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #F8F8F8;" width="100%">
        <tbody>
            <tr>
                <td>
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-1"
                        role="presentation"
                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #e4f9f7;" width="100%">
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        class="row-content" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #333; width: 600px; margin: 0 auto;"
                                        width="600">
                                        <tbody>
                                            <tr>
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div align="left" class="alignment"
                                                                    ...
                                                                    <div style="max-width: 180px;"><img alt="Image"
                                                            ...
                                                            <td class="pad">
                                                                <div align="right" class="alignment">
                                                                    <table border="0" cellpadding="0"
                                                                        ...
                                                                        width="111px">
                                                                        <tr>
                                                                            <td style="padding:0 0 0 5px;"><a
                                                                                    href="https://www.facebook.com/zidropservices"
                                                                                    target="_blank"><img alt="Facebook"
                                                                                        height="32"
                                                                                        src="https://zidrop.com/email/images/facebook2x.png"
                                                                                        style="display: block; height: auto; border: 0;"
                                                                                        title="Facebook"
                                                                                        width="32" /></a></td>
                                                                            <td style="padding:0 0 0 5px;"><a
                                                                                    href="https://twitter.com/zidropservices"
                                                                                    target="_blank"><img alt="Twitter"
                                                                                        height="32"
                                                                                        src="https://zidrop.com/email/images/twitter2x.png"
                                                                                        style="display: block; height: auto; border: 0;"
                                                                                        title="Twitter"
                                                                                        width="32" /></a></td>
                                                                            <td style="padding:0 0 0 5px;"><a
                                                                                    href="https://www.instagram.com/zidropservices/"
                                                                                    target="_blank"><img alt="Instagram"
                                                                                        height="32"
                                                                                        src="https://zidrop.com/email/images/instagram2x.png"
                                                                                        style="display: block; height: auto; border: 0;"
                                                                                        title="Instagram"
                                                                                        width="32" /></a></td>
                                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="pad" style="width:100%;">
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px">
                                                                    <div style="max-width: 600px;"><img alt="Image"
                                                                            src="https://zidrop.com/email/images/rounded_up.png"
                                                                            style="display: block; height: auto; border: 0; width: 100%;"
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-3"
                        role="presentation"
                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #f8f8f8; background-size: auto;"
                        width="100%">
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        class="row-content stack" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #FFFFFF; background-size: auto; color: #333; width: 600px; margin: 0 auto;"
                                        width="600">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1"
                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; border-left: 1px dotted #E7E7E7; padding-bottom: 35px; padding-right: 35px; padding-top: 30px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px;"
                                                    width="100%">
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        <strong>Hi {{ @$merchant->firstName }},</strong></p>
                                                                    @else
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        <strong>Hi {{ @$merchant->companyName }},</strong></p>
                                                                    @endif
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;">Your parcel (Tracking Code:
                                                                        <strong>{{ @$parcel->trackingCode }}</strong> ) has been updated:
                                                                    </p>
                                                                    <br>
                                                                    <p style="margin: 0;"><strong>Status:
                                                                        </strong>{{ @$history->status }}</p>
                                                                    <p style="margin: 0;"></p>
                                                                    <p style="margin: 0;"><strong>Note:</strong>
                                                                        {{ @$history->note ?? 'N/A' }}</p>
                                                                    <p style="margin: 0;"></p>
                                                                    <p style="margin: 0;"><strong>COD:</strong>
                                                                        ₦{{ number_format(@$parcel->cod, 2) }}</p>
                                                                    <p style="margin: 0;"></p>
                                                                    <p style="margin: 0;">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        class="row-content stack" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #FFFFFF; background-size: auto; color: #000000; width: 600px; margin: 0 auto;"
                                        width="600">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1"
...
<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://zidrop.com/merchant/login" style="height:41px;width:231px;v-text-anchor:middle;" arcsize="61%" stroke="false" fillcolor="#f2002a">
<w:anchorlock/>
<v:textbox inset="0px,5px,0px,0px">
<center style="color:#ffffff; font-family:sans-serif; font-size:18px">
<![endif]--><a href="https://zidrop.com/merchant/login" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#f2002a;border-radius:25px;width:auto;border-top:0px solid transparent;font-weight:undefined;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:5px;padding-bottom:0px;font-family:'Catamaran', 'Lucida Sans Unicode', 'Lucida Grande', sans-serif;font-size:18px;text-align:center;mso-border-alt:none;word-break:keep-all;"
                                                                        target="_blank"><span
                                                                            style="padding-left:45px;padding-right:45px;font-size:18px;display:inline-block;letter-spacing:normal;"><span
                                                                                style="word-break: break-word; line-height: 36px;">View
                                                                                Parcel
                                                                                Details</span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]-->
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px">
                                                                    <div style="max-width: 600px;"><img alt="Image"
                                                                            src="https://zidrop.com/email/images/rounded_bottom.png"
                                                                            style="display: block; height: auto; border: 0; width: 100%;"
                                                                            title="Image" width="600" /></div>
                                                                </div>
                                                            </td>
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-7"
                        role="presentation"
                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #6bcfc7;"
                        width="100%">
                        <tbody>
                            <tr>
                                <td>
                                            ...
                                            <tr>
                                                <td class="column column-1"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:40px;">
                                                                <div
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    style="color:#FFFFFF;font-family:'Catamaran', 'Lucida Sans Unicode', 'Lucida Grande', sans-serif;font-size:14px;line-height:150%;text-align:left;mso-line-height-alt:21px;">
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        Submit a ticket by logging into your account or
                                                                        register if you haven't already. Guest tickets
                                                                        are permitted, but you must verify your email
                                                                        first.</p>
                                                                </div>
                                                            </td>
                                                        </tr>
...
<![endif]--><a href="https://support.zidrop.com/guest/openticket" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:transparent;border-radius:25px;width:auto;border-top:4px solid #FFFFFF;font-weight:undefined;border-right:4px solid #FFFFFF;border-bottom:4px solid #FFFFFF;border-left:4px solid #FFFFFF;padding-top:0px;padding-bottom:0px;font-family:'Oswald', 'Lucida Sans Unicode', 'Lucida Grande', sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;"
                                                                        target="_blank"><span
                                                                            style="padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
                                                                                style="word-break:break-word;"><strong><span
                                                                                        data-mce-style=""
                                                                                        style="line-height: 28.8px;">Submit
                                                                                        Ticket</span></strong></span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]-->
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                ...
                                                <td class="column column-2"
                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-top: 35px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;"
                                                            ...
                                                            <td class="pad" style="padding-top:20px;width:100%;">
                                                                <div align="center" class="alignment"
                                                                    ...
                                                                    <div style="max-width: 200px;"><img alt="Image"
                                                                            src="https://zidrop.com/email/images/6070926.png"
                                                                            style="display: block; height: auto; border: 0; width: 100%;"
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-8"
                        role="presentation"
                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #e4f9f7; background-image: url('images/bg_footer_1.png'); background-position: top center; background-repeat: repeat;"
                        width="100%">
                        <tbody>
                            <tr>
                                <td>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    style="color:#3C82A0;font-family:'Catamaran', 'Lucida Sans Unicode', 'Lucida Grande', sans-serif;font-size:12px;line-height:120%;text-align:center;mso-line-height-alt:14.399999999999999px;">
                                                                    <p style="margin: 0; word-break: break-word;">
