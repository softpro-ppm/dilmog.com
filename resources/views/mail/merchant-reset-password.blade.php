                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        <strong> Hi {{ @$merchant->companyName }} (<a href="mailto:{{ @$merchant->emailAddress }}">{{ @$merchant->emailAddress }}</a>),</strong></p>
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;"> You have requested to reset your password in Zidrop</p>
                                                                    <p style="margin: 0;"></p>
                                                                    <p>Your password reset token is <span style="background-color: #f2f2f2;display: inline-block;padding: 9px 20px;font-size: 20px;border-radius: 12px;font-weight: 600;">{{ @$merchant->passwordReset }}</span></p>
