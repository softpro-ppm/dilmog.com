...
<head>
    ...
    <style>
        * {
        ...
        <?php
        // Set the current time with timezone GMT+1
        $originalTime = new DateTime('now', new DateTimeZone('GMT+1'));

        // Add 25 minutes
        $originalTime->modify('+25 minutes');

        // Output the new time
        //echo "New Time after 25 minutes: " . $originalTime->format('Y-m-d H:i');
        ?>
</head>
                                ...
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="column column-1"
                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; border-left: 1px dotted #E7E7E7;  padding-right: 35px; padding-top: 30px; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px;"
                                                    width="100%">
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;"> Use the following one-time password (OTP) to sign-up to your Zidrop account.
                                                                        <p style="margin: 0;"></p>
                                                                    </p>
                                                                    <p style="margin: 0;"></p>
                                                                    <br>
                                                                    <p style="margin: 0;">
                                                                            This OTP will be valid for <strong>25 minutes</strong> till <strong><?=$originalTime->format('d M, Y h:i A') . ' (GMT +01:00)';?></strong>.
                                                                         
                                                                    </p>
                                                                   
                                                                    <p style="margin: 0;"></p>
                                                                    <p style="font-size:26px; font-weight:bold; background:#f0f0f0; padding:15px; text-align:center; border-radius:6px; letter-spacing:6px; color:#000;">
                                                                        {{ @$otp }}
                                                                      </p>
