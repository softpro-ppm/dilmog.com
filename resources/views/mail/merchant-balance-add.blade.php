                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;">Your ZiDrop account has been credited with
                                                                        <strong>N{{ $topup->amount ?? 'N/A' }}</strong> </p>
                                                                    </p>
                                                                  
                                                                    <p style="margin: 0;"> </p>
                                                                    <p style="margin: 0;"><strong>Reference:
                                                                    </strong>{{ $topup->reference ?? 'N/A' }}</p>
                                                                    <p style="margin: 0;"> </p>
                                                                    <p style="margin: 0;"><strong>Email:</strong>
                                                                        {{ $topup->email ?? 'N/A' }}
                                                                    </p>
                                                                    <p style="margin: 0;"> </p>
                                                                    <p style="margin: 0;"><strong>Mobile:</strong>
                                                                        {{ $topup->mobile ?? 'N/A' }}
                                                                    </p>
                                                                    <p style="margin: 0;"> </p>
                                                                    <p style="margin: 0;">If you have any questions about this, please
