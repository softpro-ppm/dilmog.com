              ...
              <div class="col-lg-8 col-md-8 col-sm-8">
                  <div class="card card-primary">
                    <div class="card-header">
                      <h3 class="card-title">Career Info Update</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{url('editor/notice/update')}}" method="POST" enctype="multipart/form-data" name="editForm">
                      @csrf
                      ...
                      <div class="card-body">
                        ...
                        <div class="form-group">
                          <label for="text">Description</label>
                              <textarea type="text" id="editor1" class="summernote form-control {{ $errors->has('text') ? ' is-invalid' : '' }}" value="{{ old('text') }}" name="text">{!!$edit_data->text !!}</textarea>
                               @if ($errors->has('text'))
                                <span class="invalid-feedback" role="alert">
