                                ...
                                <table id="example55" class="table table-bordered table-striped custom-table">
                                    ...
                                    <tbody>
                                        @foreach ($expenses as $expense)
                                            <tr>
                                                <?php $doneBy = $expense->agent_id ? $expense->agent->name : 'Admin'; ?>
...
@section('custom_js_scripts')
    ...
    <script>
        $(document.body).on('click', '.ExpenseEditButton', function(e) {
            ...
            $('#ExpenseModal form').attr('action', '{{ route('expense.update', ':id') }}'.replace(':id', id));
        ...
        $(document.body).ready(function() {
            ...
            $('#ExpenseModal').on('hidden.bs.modal', function() {
                $('#ExpenseModal').attr('action', '{{ route('expense.store') }}');
