...
@section('content')
    ...
    border-radius: 5px;"><i
        ...
        <div class="invoice-box">
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p> Time:  {{date('h:i:s a', strtotime($DeliverymanCommission->first()->created_at))}}</p>

                                <p> Date : {{date('F d, Y', strtotime($DeliverymanCommission->first()->created_at))}}</p>
            ...
            <br>
            Total Deliveryman Commission Payment Amount: {{ number_format($DeliverymanCommission->deliveryman_commission, 2) }} N
            <br>
