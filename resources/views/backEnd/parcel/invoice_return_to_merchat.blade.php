    ...
    <div class="containerr px-3 pb-4">
            ...
            <div class="roww mt-2">
                <div class="coll mr-1 border-bottom">
                    ...
                    <div class=""> 
                        ...
                        <p class="uppercase mt-1"><span class="w-name bold">Billing Period </span> <span class="bold mr-1">:</span><span>{{$update ?? ''}}</span></p>
                ...
                <div class="coll ml-1 border-bottom pb-2">
                    ...
                    <div class="p-1">
                        <p class="uppercase"><span class="w-name bold">Account No. </span><span class="mr-1 bold">:</span> <span>9944347247 </span></p>
                        <p class="uppercase mt-1"><span class="w-name bold">Account Name </span><span class="mr-1 bold">:</span> <span>ZidropExpress/Lagos Island</span></p>
                        <p class="uppercase mt-1"><span class="w-name bold">Bank Name </span><span class="mr-1 bold">:</span> <span>Paystack-Titan</span></p>
                ...
                <div class="coll">
                    <table>
                        <tr>
                            ...
                            <th class="uppercase text-center" width="20%">Address/Delivery City/Town</th>
                            ...
                            <tr>
                               <td width="20%">{{ $parcel->trackingCode }}</td>
                                ...
                                <td width="20%" class="text-center">{{ $parcel->created_at }}</td>
                                 ...
                                 <td>{{ $parcel->recipientAddress }} /{{ $parcel->deliverycity->title }} / {{ $parcel->deliverytown->title }}</td>
                                <td width="20%" class="text-right">{{ number_format( $parcel->deliveryCharge + $parcel->tax + $parcel->insurance , 2) }} N</td>
                            </tr>
                            @php $deliveryCharge +=$parcel->deliveryCharge + $parcel->tax + $parcel->insurance @endphp
                        @endforeach
                    </table>
                </div>
            </div>
            ...
            <div class="roww mt-2">
                ...
                <div class="coll ml-1 pb-2">
                    <div class="p-1">
                        <p class="uppercase"><span class="w-name bold" style="min-width: 75px">Amount Due </span><span class="mr-1 bold">:</span> <span class="text-right footer_amount bold">{{ number_format($deliveryCharge, 2) }} N</span></p>
                    </div>
                </div>
            </div>
        </div>
