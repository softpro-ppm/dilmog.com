                          ...
                          <!-- col end -->
                            ...
                            <div class="card-body">
                                <form action="{{ url('editor/agent/confirm-payment') }}" method="POST" id="myform"
                                    ...
                                    <button type="button" class="bulkbutton bulk-status-btn mb-2"
                                    ...
                                    <table id="agentpayment" class="table table-bordered table-striped custom-table">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            @foreach ($show_data as $key => $value)
                                                @php
                                                    ...
                                                    $agent = App\Agent::find($value->agentId);
                                                ...
                                                @if ($due > 0)
                                                    <tr>
                                                        ...
                                                        <td>{{ $value->created_at }}</td>
                                                         <td>
                                                            @if($value->status!=1)
                                                            <button type="button" class="btn btn-danger">Requested</button>
                                                            @else
