                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                       ...
                       <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="tax" id="tax" class="form-control {{ $errors->has('tax') ? ' is-invalid' : '' }}" value="{{ $edit_data->tax }}">
                           @if ($errors->has('tax'))
                            <span class="invalid-feedback">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="insurance" id="insurance" class="form-control {{ $errors->has('insurance') ? ' is-invalid' : '' }}" value="{{ $edit_data->insurance }}">
