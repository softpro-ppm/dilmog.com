                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="phone" id="phone" placeholder="0802 123 4567" class="form-control pr-5 {{ $errors->has('phone') ? ' is-invalid' : '' }}" value="{{ old('phone') }}">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="number" name="commision" id="commision" class="form-control {{ $errors->has('commision') ? ' is-invalid' : '' }}" value="{{ old('commision') }}" step="any">
