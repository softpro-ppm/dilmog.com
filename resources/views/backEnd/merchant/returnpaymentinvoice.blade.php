...
@section('title','Manage Merchant Return-Payment')
@section('content')
  <!-- Main content -->
                    ...
                    <div class="col-sm-12">
                      <div class="manage-button">
                        <div class="body-title">
                          <h4><b><p style="color:green">Manage Merchant Return Payment</P></b></h4>
                        </div>
                      </div>
                    </div>
                  <div class="card-body">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                                <ul>
                                    <li>
                                      <form action="{{ url('author/merchant/payment/return-invoice-details') }}" target="_blank" method="post">
                                        @csrf
