    ...
    <div class="containerr px-3 pb-4">
        ...
        <div class="roww mt-2">
            <div class="coll mr-1 border-bottom">
                ...
                <div class="">
                    ...
                    <p class="uppercase mt-1"><span class="w-name bold">Total Tax Amount </span> <span
            ...
            <div class="coll">
                <table class="table2">
                    <tr>
                        ...
                        <th class="uppercase text-center" width="">Tax Amount</th>
                    </tr>
                    @foreach ($reports as $parcel)
                        <tr>
                            ...
                            <td width="" class="text-right">{{ number_format($parcel->deliveryCharge + $parcel->codCharge, 2) }} N</td>
                            <td width="" class="text-right">{{ number_format($parcel->tax, 2) }} N</td>
                        </tr>
                    @endforeach
                </table>
            </div>
        ...
        <div class="roww mt-2">
            ...
            <div class="coll ml-1 pb-2">
                <div class="p-1">
                    <p class="uppercase"><span class="w-name bold" style="min-width: 75px">Total Tax Amount </span><span
