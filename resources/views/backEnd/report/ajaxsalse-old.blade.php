        ...
        <div class="roww">
            <div class="text-right">
                <button onclick="myFunction2()"
                    style="color: #fff;border: 0;padding: 6px 12px;margin-bottom: 8px;background: green">Print</button>
                {{-- <button onclick="myFunction2()"
                    style="color: #fff;border: 0;padding: 6px 12px;margin-bottom: 8px;background: green">Export CSV/Excel</button> --}}
            </div>
    ...
    <div class="containerr px-3 pb-4">
        ...
        <div class="row">
            <div class="coll">
                <table class="table2">
                        <tr>
                            <th class="uppercase text-center" width="">Tracking ID</th>
                            <th class="uppercase text-center" width="">Item</th>
                            <th class="uppercase text-center" width="">Date Created</th>
                            <th class="uppercase text-center" width="">Address/Area/State</th>
                            <th class="uppercase text-center" width="">Charge</th>
                        </tr>
                    <tbody>
                      
                    @foreach ($reports as $parcel)
                        <tr>
                            <td width="">{{ $parcel->trackingCode }}</td>
                            <td width="" class="text-center">{{ $parcel->productName }}
                                <small><strong>({{ @$parcel->productQty }})</strong></small></td>
                            <td width="" class="text-center">{{ $parcel->created_at }}</td>
                            ...
                            <td width="" class="text-right">{{ number_format($parcel->Charge, 2) }}</td>
                        </tr>
                    @endforeach
                    </tbody>
        ...
        <div class="roww mt-2">
            ...
            {{-- <div class="coll ml-1 pb-2">
                <div class="p-1">
                    <p class="uppercase"><span class="w-name bold" style="min-width: 75px">Total </span><span
                            class="mr-1 bold">:</span> <span
                            class="text-right footer_amount bold">{{ number_format($total, 2) }}</span></p>
                </div>
            </div> --}}
        </div>
    </div>
