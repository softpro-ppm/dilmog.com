        ...
        <div class="roww mt-2">
            <div class="coll mr-1 border-bottom">
                ...
                <div class="">
                    ...
                    <p class="uppercase mt-1"><span class="w-name bold">Total Delivery Charge Amount </span> <span
                            class="bold mr-1">:</span>
                        <?php
                        $total = 0;
                        foreach ($reports as $parcel) {
                            $total += $parcel->deliveryCharge;
                        }
                        ?>
            ...
            <div class="coll">
                <table class="table2">
                    <tr>
                        ...
                        <th class="uppercase text-center" width="">Parcel Status</th>
                        <th class="uppercase text-center" width="">Date Updated</th>
                        <th class="uppercase text-center" width="">Address/City/Town</th>
                        <th class="uppercase text-center" width="">Weight</th>
                        <th class="uppercase text-center" width="">Delivery Charge</th>
                    </tr>
                    @foreach ($reports as $parcel)
                        <tr>
                            <td width="">{{ $parcel->trackingCode }}</td>
                            <td width="">{{ $parcel->parceltype->title }}</td>
                            <td width="" class="text-center">{{ $parcel->updated_at }}</td>
                            <td>{{ $parcel->recipientAddress }} /
                                {{ $parcel->pickupcity->title }} /
                                {{ $parcel->deliverytown->title }}
                            </td>
                            <td width="" class="text-right">{{ $parcel->productWeight }} kg</td>
                            <td width="" class="text-right">{{ number_format($parcel->deliveryCharge, 2) }} N</td>
                        </tr>
                    @endforeach
                </table>
            </div>
