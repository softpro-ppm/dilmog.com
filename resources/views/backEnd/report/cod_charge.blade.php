    ...
    <div class="containerr px-3 pb-4">
        ...
        <div class="roww mt-2">
            <div class="coll mr-1 border-bottom">
                ...
                <div class="">
                    ...
                    <p class="uppercase mt-1"><span class="w-name bold">Total COD Charge Amount </span> <span
                            class="bold mr-1">:</span>
                        <?php
                        $total = 0;
                        foreach ($reports as $parcel) {
                            $total += $parcel->codCharge;
                        }
                        ?>
            ...
            <div class="coll">
                <table class="table2">
                    <tr>
                        ...
                        <th class="uppercase text-center" width="">COD Charge</th>
                    </tr>
                    @foreach ($reports as $parcel)
                        <tr>
                            ...
                            <td width="" class="text-right">{{ number_format($parcel->codCharge, 2) }} N</td>
                        </tr>
                    @endforeach
                </table>
            </div>
        ...
        <div class="roww mt-2">
            ...
            <div class="coll ml-1 pb-2">
                <div class="p-1">
                    <p class="uppercase"><span class="w-name bold" style="min-width: 75px">Total COD Charge Amount </span><span
