    ...
    <div class="containerr px-3 pb-4">
        ...
        <div class="roww mt-2">
            <div class="coll mr-1 border-bottom">
                ...
                <div class="">
                    ...
                    <p class="uppercase mt-1"><span class="w-name bold">Total Insurance Amount </span> <span
                            class="bold mr-1">:</span>
                        <?php
                        $total = 0;
                        foreach ($reports as $parcel) {
                            $total += $parcel->insurance;
                        }
                        ?>
            ...
            <div class="coll">
                <table class="table2">
                    <tr>
                        ...
                        <th class="uppercase text-center" width="">COD</th>
                        <th class="uppercase text-center" width="">Insurance Amount</th>
                    </tr>
                    @foreach ($reports as $parcel)
                        <tr>
                            ...
                            <td width="" class="text-right">{{ number_format($parcel->cod, 2) }} N</td>
                            <td width="" class="text-right">{{ number_format($parcel->insurance, 2) }} N</td>
                        </tr>
                    @endforeach
                </table>
            </div>
        ...
        <div class="roww mt-2">
            ...
            <div class="coll ml-1 pb-2">
                <div class="p-1">
                    <p class="uppercase"><span class="w-name bold" style="min-width: 75px">Total Insurance Amount </span><span
