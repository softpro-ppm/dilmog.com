                                    ...
                                    <tbody>
                                        @foreach ($show_data as $key => $value)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <button class="btn btn-primary" data-toggle="modal"
                                                            data-target="#asignModal{{ $value->id }}">Asign</button>
                                                    @endif
                                                </td>
                                                <td>
                                                    @if ($value->deliveryman)
                                                        {{ $deliverymanInfo->name }}
                                                    @else
                                                        <button class="btn btn-primary" data-toggle="modal"
                                                            data-target="#riderasignModal{{ $value->id }}">Asign</button>
                                                    @endif
                                                </td>
                                                <td>
                                                    @if ($value->status == 0)
                                                ...
                                                <div id="riderasignModal{{ $value->id }}" class="modal fade"
                                                    role="dialog">
                                                    <div class="modal-dialog">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{ url('editor/pickup/deliveryman/asign') }}"
                                                                    method="POST">
                                                                    @csrf
                                                        ...
                                                        <li>
                                                            ...
                                                            <div id="sUpdateModal{{ $value->id }}" class="modal fade"
                                                                ...
                                                                <div class="modal-dialog">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title">Pickup Status Update
                                                                            </h5>
                                                                        </div>
                                                                        <div class="modal-body">
                                                                            @if ($value->agent != 0)
                                                                                <form
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <select name="status"
                                                                                            ...
                                                                                            dissable="dissable">
                                                                                            <option
                                                                                                value="1"@if ($value->status == 1) selected="selected" @endif>
                                                                                                Pending</option>
                                                                                            <option
                                                                                                value="2"@if ($value->status == 2) selected="selected" @endif>
                                                                                                Accepted</option>
                                                                                            <option
                                                                                                value="3"@if ($value->status == 3) selected="selected" @endif>
                                                                                                Cancelled</option>
                                                                                        </select>
                                                                                    </div>
                                                                                    <!-- form group end -->
