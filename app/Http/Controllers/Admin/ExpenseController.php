...
class ExpenseController extends Controller
{
    ...
    {
    	$expenses = Expense::where('status',1)->with('expensetype')->with('agent')->orderBy('id','DESC')->get();
    	...
    	return view('backEnd.expense.index',compact('expenses','ExpenseTypes','lastExpNUmber'));
    }
